...
{Template {
    $classpath: "templates.pages.transition.TransitionsSlideRightPage",
    $css: ["templates.pages.transition.TransitionsStyle"]
}}

{macro main()}
    <h1 class="slideright">This page is sliding from the right</h1>
    <span class="slideright">
